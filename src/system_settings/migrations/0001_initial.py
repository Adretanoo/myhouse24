# Generated by Django 5.2.5 on 2025-08-26 07:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=255)),
                ('units_measurement', models.ForeignKey(default='manager', on_delete=django.db.models.deletion.CASCADE, to='system_settings.unitsmeasurement')),
            ],
            options={
